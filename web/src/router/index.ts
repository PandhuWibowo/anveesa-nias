    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'ssh-hosts',
          name: 'ssh-hosts',
          component: () => import('@/views/SshHostsView.vue'),
          meta: { requiredPermissionsAny: ['docker.view', 'docker.manage', 'sftp.access', 'sftp.manage'] },
        },
        { path: 'docker-hosts', redirect: { name: 'ssh-hosts' } },
        { path: 'sftp-hosts', redirect: { name: 'ssh-hosts' } },
        {
          path: 'docker',
          name: 'docker',
