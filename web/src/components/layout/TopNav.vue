...
const allMenuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'pg-parameters', label: 'Postgres Parameters', desc: 'Inspect pg_settings and change server parameters with ALTER SYSTEM SET on a Postgres connection', icon: 'settings', section: 'Database', permissionsAny: ['pgparameters.view', 'pgparameters.manage'] },
    ],
  },
  {
    id: 'admin',
