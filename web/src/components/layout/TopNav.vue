...
const allMenuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'marketplace', label: 'Marketplace', desc: 'One-click deploy self-hosted apps to your servers and pin tools', icon: 'marketplace', permissionsAny: ['marketplace.view', 'marketplace.manage'] },
    ],
  },
  {
    id: 'admin',
...
const ICON_PATHS: Record<string, string> = {
  ...
  marketplace: '<path d="M3 9 4 4h16l1 5"/><path d="M4 9v11h16V9"/><path d="M3 9h18"/><path d="M9 9v3a3 3 0 0 1-6 0"/><path d="M15 9v3a3 3 0 0 1-6 0V9"/><path d="M21 9v3a3 3 0 0 1-6 0V9"/>',
}
