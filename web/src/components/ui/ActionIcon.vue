...
// Small shared icon set for row-action buttons/menus (RowActionsMenu.vue and
// anywhere else that wants a consistent glyph instead of ad hoc SVGs/emoji).
// Unrecognized names fall back to a plain dot rather than rendering nothing.
